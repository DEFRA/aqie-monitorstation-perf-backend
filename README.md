...
```bash
cd aqie-monitorstation-perf-backend
nvm use
```
...
```bash
docker build --target development --no-cache --tag aqie-monitorstation-perf-backend:development .
```

Run:

```bash
docker run -e PORT=3001 -p 3001:3001 aqie-monitorstation-perf-backend:development
```
...
```bash
docker build --no-cache --tag aqie-monitorstation-perf-backend .
```

Run:

```bash
docker run -e PORT=3001 -p 3001:3001 aqie-monitorstation-perf-backend
```
